...
export default function FoodSearch() {
  ...
  useEffect(() => {
    getFoods({ keyword: debouncedKeyword, category, minCal: Math.min(calMin, calMax), maxCal: Math.max(calMin, calMax), page, limit: 12 })
  ...
  const handleConfirmAdd = async () => {
    ...
    const summary = await getDailySummary(getTodayISO())
