...
export default function Settings() {
  ...
  useEffect(() => {
    getProfile().then(p => {
      ...
      setForm({
        ...
        activityLevel: prof.activityLevel || 'sedentary',
        dietGoal: prof.dietGoal || 'maintain',
        targetCalories: prof.targetCalories || 2000,
        targetProtein: prof.targetProtein || 0,
        targetFat: prof.targetFat || 0,
        targetCarb: prof.targetCarb || 0,
        displayName: prof.displayName || session.displayName || ''
      })
    }).catch(() => {})
  }, [])
  ...
  const applySuggested = async () => {
    if (suggestedCal) {
      ...
      await updateProfile({ targetCalories: suggestedCal })
