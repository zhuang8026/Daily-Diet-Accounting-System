...
export default function AdminAnnouncements() {
  ...
  const handleSave = async () => {
    ...
    if (formData.startDate > formData.endDate) { showToast('開始日期不得晚於結束日期', 'warning'); return }

    const payload = { title, content, startDate: formData.startDate, endDate: formData.endDate, isActive: formData.isActive }
